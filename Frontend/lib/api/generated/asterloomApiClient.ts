 ...
 */
export interface AsterloomApiClient extends BaseRequestBuilder<AsterloomApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link AsterloomApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createAsterloomApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<AsterloomApiClient>(requestAdapter, pathParameters, AsterloomApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const AsterloomApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const AsterloomApiClientNavigationMetadata: Record<Exclude<keyof AsterloomApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
