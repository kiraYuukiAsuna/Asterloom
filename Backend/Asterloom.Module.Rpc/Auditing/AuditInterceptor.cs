    ...
    ILogger<AuditInterceptor> logger) : Interceptor
{
    ...
    private static readonly Dictionary<string, AuditResourceDescriptor> Resources =
        new(StringComparer.Ordinal)
        {
            ...
            [AuthorizationMethod("CreatePermission")] = new("authorization_permission", null),
            [AuthorizationMethod("UpdatePermission")] = new("authorization_permission", "permission_id"),
            [AuthorizationMethod("ArchivePermission")] = new("authorization_permission", "permission_id"),
            [AuthorizationMethod("RestorePermission")] = new("authorization_permission", "permission_id"),
