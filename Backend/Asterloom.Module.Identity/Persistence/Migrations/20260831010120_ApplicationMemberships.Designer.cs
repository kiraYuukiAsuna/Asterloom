...
{
    [DbContext(typeof(AsterloomIdentityDbContext))]
    [Migration("20260831010120_ApplicationMemberships")]
    partial class ApplicationMemberships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Asterloom.Modules.Identity.Model.AsterloomUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
